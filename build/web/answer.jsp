...
<body>
 ...
 <form method="post" action="answer_submit.jsp?id=<%=code%>">
 <div class="container">
      <div class="row">
                ...
                <div class="panel panel-default">
                  ...
                  <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body" style="height: 350px">
                        ...
                        <textarea class="form-control" name="answer" rows="15" required="required"></textarea>
     ...
     <input type="submit" class="w3-blue w3-center" value="submit">
 </div>
 </form>
