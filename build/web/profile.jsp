  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="myques.jsp" style="font-size: 20px">My questions</a></li>
...
<!--model 1-->
 ...
 <div style="margin-left:300px"> 
        <div class="col-sm-12">
            ...
            <div class="w3-card" style="margin: 20px; height: 70px">
                <div class="w3-panel">
                    <div class="w3-bar w3-boader w3-white w3-round-large ">
                            <a href="question.jsp" ><button class="w3-button w3-blue w3-hover-red w3-center w3-round-large" style="margin-left: 350px">Ask Question</button></a>                            
                    </div>                       
                </div>
            </div>
