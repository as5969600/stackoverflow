<%-- 
    Document   : edit
    Created on : Feb 24, 2020, 1:59:03 PM
    Author     : user
--%>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <%
            ...
            if(rs.next()){
      %>       
 <form method="post" action="update.jsp?id=<%=code%>">
 <div class="container">
      <div class="row">
                ...
                <div class="panel panel-default">
                  ...
                  <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body" style="height: 200px">
                        ...
                        <textarea class="form-control" name="question" rows="5"> <%=rs.getString(4)%></textarea>
                ...
                <div class="panel panel-default">
                  ...
                  <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body" style="height: 200px">
                        ...
                        <textarea class="form-control" name="descrip" rows="7" ><%=rs.getString(5)%></textarea>
   ...
   <input type="submit" class="w3-blue center-block" value="Update">
 </form>
    <%
                            }
   %>
