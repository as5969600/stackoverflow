  ...
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-10" > 
            <div class="row">
                    <div class="col-sm-11">
                            <div class="w3-card w3-black w3-hover-shadow w3-center" style="margin-left: 40px;margin-top: 20px; height: 50px ">
                                <p style="font-size: 25px"><a href="#" >Add Categories</a></p>
                            </div>
                    </div>
            </div>
            <div class="row">
                        ...
                        <div style="margin: 100px">
                            <form method="post" action="register_category.jsp">
                                <input type="text" style="width: 500px;color: black" name="category" placeholder="e.g.=java" required="required">
